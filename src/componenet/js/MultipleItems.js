...
class MultipleItems extends Component {
  ...
  render() {
    ...
    return (
      <div style={{margin:'auto',padding:'20%',paddingTop:'50px',paddingBottom:'50px' ,textAlign:'center',backgroundColor:'none'}}  >
        <h2 style={{color:'white',marginBottom:'50px'}}> {uzLang?"Foto Lavhalar":enLang?"Photo Sheets":"Фото листы"} </h2>
      <div className={s.carousel1} style={{margin:'auto',padding:'20%',paddingTop:'50px',paddingBottom:'50px' ,textAlign:'center',backgroundColor:'none'}}  >
...
export default connect(mapStateToProps, {uzLanguege,  ruLanguege, enLanguege })(MultipleItems);